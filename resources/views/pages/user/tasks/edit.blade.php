...
@section('content')
    <section>
        <div class="container">
            ...
            <br><br>
            @lang('user.pages.tasks.top.edit'):
            <br><br>
            <form action="{!! action('User\TaskController@update', $task->id) !!}" method="post">
                ...
                @endfor
                <br><br>
                <button type="submit" class="btn btn-default" name="actionBtn" value="update">
                    @lang('user.pages.tasks.buttons.save')
                </button>
            </form>
            <div>
                <form action="{!! action('User\TaskController@destroy', $task->id) !!}" method="post">
                    ...
                    <button type="submit" class="btn btn-default" name="actionBtn" value="delete">
                        @lang('user.pages.tasks.buttons.delete')
                    </button>
                </form>
            </div>
        </div>
